...
return _2("dojox.geo.charting.KeyboardInteractionSupport",null,{map:null,_zoomEnabled:false,constructor:function(_9,_a){
this.map=_9;
if(_a){
this._zoomEnabled=_a.enableZoom;
}
},connect:function(){
var _b=_6.byId(this.map.container);
...
if(this.map.selectedFeature||this.map.focused){
return;
}
this.map.focused=true;
var _c,_d=false;
if(this.map.lastSelectedFeature){
_c=this.map.lastSelectedFeature;
}else{
var _e=this.map.getMapCenter(),_f=Infinity;
_7.forIn(this.map.mapObj.features,function(_10){
...
this.map.mapObj.marker.show(_c.id);
}
},onBlur:function(){
this.map.lastSelectedFeature=this.map.selectedFeature;
},_directTo:function(up,_12,_13,_14){
var _15=this.map.selectedFeature,_16=_15._center[0],_17=_15._center[1],_18=Infinity,_19=null;
_7.forIn(this.map.mapObj.features,function(_1a){
...
this.map.mapObj.marker.show(_19.id);
}
}});
});
